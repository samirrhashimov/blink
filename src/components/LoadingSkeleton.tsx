      ...
      case 'container':
        return (
          <div className="container-skeleton">
            <div className="skeleton-box skeleton-box--rounded shimmer" style={{ height: '180px', marginBottom: '1rem' }}></div>
            <div className="skeleton-box shimmer" style={{ width: '70%', height: '20px', marginBottom: '0.5rem' }}></div>
            <div className="skeleton-box shimmer" style={{ width: '50%', height: '16px' }}></div>
          </div>
        );
        ...
        return (
          <div className="card-skeleton">
            <div className="card-skeleton__header">
              <div className="skeleton-box skeleton-box--circle shimmer" style={{ width: '40px', height: '40px' }}></div>
              <div className="skeleton-box shimmer" style={{ width: '60%', height: '20px' }}></div>
            </div>
            <div className="skeleton-box shimmer" style={{ width: '100%', height: '16px', margin: '0.5rem 0' }}></div>
            <div className="skeleton-box shimmer" style={{ width: '80%', height: '16px' }}></div>
          </div>
        );

      case 'avatar':
        return <div className="skeleton-box skeleton-box--circle shimmer" style={{ width: '48px', height: '48px' }}></div>;

      case 'text':
      default:
        return <div className="skeleton-box shimmer" style={{ width: '100%', height: '16px' }}></div>;
    }
  };
