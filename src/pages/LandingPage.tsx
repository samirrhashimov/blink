      ...
      <section className="feature-section-alternating">
        ...
        <div className="feature-row feature-row-firefox">
          <div className="feature-text-firefox">
            <img src={firefoxExtImg} alt="Firefox Extension" className="mb-4" style={{ width: '230px', borderRadius: '10px 0' }} />
            <h2 className="feature-section-title firefox-title">Blink for Firefox</h2>
            <p className="feature-section-desc firefox-desc">
              Save any webpage directly to your Blink containers with a single click. Fast, secure, and organized.
            </p>
            <a
