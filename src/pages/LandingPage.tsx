        ...
        <div className="bg-blue-50 dark:bg-blue-700 rounded-3xl p-12 mx-4 max-w-6xl md:mx-auto text-gray-900 dark:text-white shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            <div className="flex gap-4 flex-col sm:flex-row">
              <Link to="/login" style={{ padding: '1rem 1.5rem' }} className="px-8 py-4 bg-blue-200 dark:bg-blue-700 bg-opacity-50 text-black dark:text-white font-semibold rounded-full hover:bg-opacity-70 transition-colors border border-blue-400">
